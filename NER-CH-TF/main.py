...
parser = argparse.ArgumentParser(
    description='bi-lstm-crf for Chinese NER task')
...
parser.add_argument('--update_embedding', type=str2bool,
                    default=True, help='update embedding during training')
...
parser.add_argument('--demo_model', type=str,
                    default='180ai', help='model for test and demo')
...
# demo
    ...
    with tf.Session(config=config) as sess:
        ...
        while(1):
            ...
            demo_sent = input()
            if demo_sent == 'exit' or demo_sent.isspace():
