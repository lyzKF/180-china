...
class text_segmentation():
    ...
    def cut_remove_word_function(self, stop_words_temp):
        ...
        for sentence in self.data_temp:
            ...
            for word in list(cut_words_temp):
...
def run():
    ...
    #
    jd.log_info("训练LDA模型.......")
    lda = models.LdaModel(corpus_tfidf, id2word=word_dict, num_topics=50)
    """
    ...
    result_topic = lda.show_topics(num_topics=50, num_words= 10)
